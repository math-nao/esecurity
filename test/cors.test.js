...
describe('cors', function () {
    ...
    describe('with credentials', function () {
        describe('preflight request', function () {
            ...
            it('should work with an "*" allowed origin', function (done) {
                var app = express();
            ...
            it('should not work with a case-sensitive method', function (done) {
                var app = express();
            ...
            it('should worl with a case-insensitive request header', function (done) {
                var app = express();
                ...
                .set('Access-Control-Request-Headers', 'x-pingother')
                .end(function (err, res) {
                    res.headers.should.have.property('access-control-allow-headers', 'X-Pingother');
                    done();
                });
            });
        });
